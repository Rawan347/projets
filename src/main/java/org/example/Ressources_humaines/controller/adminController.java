...
//
//
//        String jpql = "SELECT DISTINCT t.etat FROM Tache t";

//        TypedQuery<Tache.Etat> query = em.createQuery(jpql, Tache.Etat.class);
//        List<Tache.Etat> etatList = query.getResultList();

        ObservableList<String> observableList = FXCollections.observableArrayList();
        observableList.add("en_cours");
        observableList.add("termine");
//        for (Tache.Etat etat : etatList)
//        {
//            observableList.add(etat.toString());
//        }
